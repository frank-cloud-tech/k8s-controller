...
import (
	...
	foov1alpha1 "k8s-controller/handwriting/with_crd/generated/applyconfiguration/foo/v1alpha1"
	scheme "k8s-controller/handwriting/with_crd/generated/clientset/versioned/scheme"
	"time"
...
type FooInterface interface {
	...
	Apply(ctx context.Context, foo *foov1alpha1.FooApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Foo, err error)
	ApplyStatus(ctx context.Context, foo *foov1alpha1.FooApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Foo, err error)
	FooExpansion
}
...
func newFoos(c *FrankV1alpha1Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Apply(ctx context.Context, foo *foov1alpha1.FooApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Foo, err error) {
	if foo == nil {
...
func (c *foos) ApplyStatus(ctx context.Context, foo *foov1alpha1.FooApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Foo, err error) {
	if foo == nil {
		return nil, fmt.Errorf("foo provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
