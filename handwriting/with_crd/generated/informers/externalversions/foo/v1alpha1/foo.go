...
import (
	"context"
	foov1alpha1 "k8s-controller/handwriting/with-crd/apis/foo/v1alpha1"
	versioned "k8s-controller/handwriting/with-crd/generated/clientset/versioned"
	internalinterfaces "k8s-controller/handwriting/with-crd/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s-controller/handwriting/with-crd/generated/listers/foo/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FrankV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FrankV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&foov1alpha1.Foo{},
		resyncPeriod,
